...
function generateButton(props: Record<string, unknown>): {
  tsx: string
  css: string
} {
...
// ─── Badge ───────────────────────────────────────────────────────────────────
function generateBadge(props: Record<string, unknown>): {
  tsx: string
  css: string
} {
...
// ─── Spinner ─────────────────────────────────────────────────────────────────
function generateSpinner(props: Record<string, unknown>): {
  tsx: string
  css: string
} {
  const color = (props.color as string) ?? '#7F77DD'
...
// ─── Progress ────────────────────────────────────────────────────────────────
function generateProgress(props: Record<string, unknown>): {
  tsx: string
  css: string
} {
  const color = (props.color as string) ?? '#7F77DD'
...
// ─── Avatar ──────────────────────────────────────────────────────────────────
function generateAvatar(props: Record<string, unknown>): {
  tsx: string
  css: string
} {
  const color = (props.color as string) ?? '#7F77DD'
...
// ─── Input ───────────────────────────────────────────────────────────────────
function generateInput(props: Record<string, unknown>): {
  tsx: string
  css: string
} {
  const color = (props.color as string) ?? '#7F77DD'
...
// ─── Toggle ──────────────────────────────────────────────────────────────────
function generateToggle(props: Record<string, unknown>): {
  tsx: string
  css: string
} {
  const color = (props.color as string) ?? '#7F77DD'
...
// ─── Checkbox ────────────────────────────────────────────────────────────────
function generateCheckbox(props: Record<string, unknown>): {
  tsx: string
  css: string
} {
  const color = (props.color as string) ?? '#7F77DD'
...
// ─── Radio ───────────────────────────────────────────────────────────────────
function generateRadio(props: Record<string, unknown>): {
  tsx: string
  css: string
} {
  const color = (props.color as string) ?? '#7F77DD'
...
// ─── Textarea ────────────────────────────────────────────────────────────────
function generateTextarea(props: Record<string, unknown>): {
  tsx: string
  css: string
} {
  const color = (props.color as string) ?? '#7F77DD'
...
// ─── Card ────────────────────────────────────────────────────────────────────
function generateCard(props: Record<string, unknown>): {
  tsx: string
  css: string
} {
  const color = (props.color as string) ?? '#7F77DD'
...
// ─── Select ──────────────────────────────────────────────────────────────────
function generateSelect(props: Record<string, unknown>): {
  tsx: string
  css: string
} {
  const color = (props.color as string) ?? '#7F77DD'
...
// ─── Slider ──────────────────────────────────────────────────────────────────
function generateSlider(props: Record<string, unknown>): {
  tsx: string
  css: string
} {
  const color = (props.color as string) ?? '#7F77DD'
...
// ─── StatCard ────────────────────────────────────────────────────────────────
function generateStatCard(props: Record<string, unknown>): {
  tsx: string
  css: string
} {
  const color = (props.color as string) ?? '#7F77DD'
...
// ─── TagInput ────────────────────────────────────────────────────────────────
function generateTagInput(props: Record<string, unknown>): {
  tsx: string
  css: string
} {
  const color = (props.color as string) ?? '#7F77DD'
...
// ─── Tabs ────────────────────────────────────────────────────────────────────
function generateTabs(props: Record<string, unknown>): {
  tsx: string
  css: string
} {
  const color = (props.color as string) ?? '#7F77DD'
...
// ─── Breadcrumb ──────────────────────────────────────────────────────────────
function generateBreadcrumb(props: Record<string, unknown>): {
  tsx: string
  css: string
} {
  const color = (props.color as string) ?? '#7F77DD'
...
// ─── Pagination ──────────────────────────────────────────────────────────────
function generatePagination(props: Record<string, unknown>): {
  tsx: string
  css: string
} {
  const color = (props.color as string) ?? '#7F77DD'
...
// ─── Navbar ──────────────────────────────────────────────────────────────────
function generateNavbar(props: Record<string, unknown>): {
  tsx: string
  css: string
} {
  const color = (props.color as string) ?? '#7F77DD'
...
// ─── DatePicker ──────────────────────────────────────────────────────────────
function generateDatePicker(props: Record<string, unknown>): {
  tsx: string
  css: string
} {
  const color = (props.color as string) ?? '#7F77DD'
...
// ─── FadeUp ──────────────────────────────────────────────────────────────────
function generateFadeUp(props: Record<string, unknown>): {
  tsx: string
  css: string
} {
  const color = (props.color as string) ?? '#7F77DD'
...
// ─── Ticker ──────────────────────────────────────────────────────────────────
function generateTicker(props: Record<string, unknown>): {
  tsx: string
  css: string
} {
  const color = (props.color as string) ?? '#7F77DD'
...
// ─── MorphBlob ───────────────────────────────────────────────────────────────
function generateMorphBlob(props: Record<string, unknown>): {
  tsx: string
  css: string
} {
  const color = (props.color as string) ?? '#7F77DD'
...
// ─── CountUp ─────────────────────────────────────────────────────────────────
function generateCountUp(props: Record<string, unknown>): {
  tsx: string
  css: string
} {
  const color = (props.color as string) ?? '#7F77DD'
...
// ─── Modal ───────────────────────────────────────────────────────────────────
function generateModal(props: Record<string, unknown>): {
  tsx: string
  css: string
} {
  const color = (props.color as string) ?? '#7F77DD'
...
// ─── Toast ───────────────────────────────────────────────────────────────────
function generateToast(props: Record<string, unknown>): {
  tsx: string
  css: string
} {
...
// ─── Tooltip ─────────────────────────────────────────────────────────────────
function generateTooltip(props: Record<string, unknown>): {
  tsx: string
  css: string
} {
  const color = (props.color as string) ?? '#7F77DD'
...
// ─── Dropdown ────────────────────────────────────────────────────────────────
function generateDropdown(props: Record<string, unknown>): {
  tsx: string
  css: string
} {
  const color = (props.color as string) ?? '#7F77DD'
  ...
  const dangerItems = (props.dangerItems as boolean[]) ?? items.map(() => false)
...
// ─── Drawer ──────────────────────────────────────────────────────────────────
function generateDrawer(props: Record<string, unknown>): {
  tsx: string
  css: string
} {
  const color = (props.color as string) ?? '#7F77DD'
...
// ─── Skeleton ────────────────────────────────────────────────────────────────
function generateSkeleton(props: Record<string, unknown>): {
  tsx: string
  css: string
} {
  const radius = (props.radius as number) ?? 8
...
// ─── Alert ───────────────────────────────────────────────────────────────────
function generateAlert(props: Record<string, unknown>): {
  tsx: string
  css: string
} {
  const variant = (props.variant as string) ?? 'success'
...
// ─── Stepper ─────────────────────────────────────────────────────────────────
function generateStepper(props: Record<string, unknown>): {
  tsx: string
  css: string
} {
  const color = (props.color as string) ?? '#7F77DD'
...
// ─── Accordion ───────────────────────────────────────────────────────────────
function generateAccordion(props: Record<string, unknown>): {
  tsx: string
  css: string
} {
  const color = (props.color as string) ?? '#7F77DD'
...
// ─── Table ───────────────────────────────────────────────────────────────────
function generateTable(props: Record<string, unknown>): {
  tsx: string
  css: string
} {
  const color = (props.color as string) ?? '#7F77DD'
...
const DEFAULT_ROWS: (string | number)[][] = [
  ${columns
    .map((_, i) => `[${columns.map((c, j) => `'${c} ${i + 1}'`).join(', ')}]`)
    .slice(0, 3)
    .join(',\n  ')},
]
...
// ─── SideNav ─────────────────────────────────────────────────────────────────
function generateSideNav(props: Record<string, unknown>): {
  tsx: string
  css: string
} {
  const color = (props.color as string) ?? '#7F77DD'
...
// ─── CommandPalette ───────────────────────────────────────────────────────────
function generateCommandPalette(props: Record<string, unknown>): {
  tsx: string
  css: string
} {
  const color = (props.color as string) ?? '#7F77DD'
...
// ─── BarChart ─────────────────────────────────────────────────────────────────
function generateBarChart(props: Record<string, unknown>): {
  tsx: string
  css: string
} {
  const color = (props.color as string) ?? '#7F77DD'
...
// ─── LineChart ────────────────────────────────────────────────────────────────
function generateLineChart(props: Record<string, unknown>): {
  tsx: string
  css: string
} {
  const color = (props.color as string) ?? '#1D9E75'
...
// ─── Donut ────────────────────────────────────────────────────────────────────
function generateDonut(props: Record<string, unknown>): {
  tsx: string
  css: string
} {
  const color = (props.color as string) ?? '#7F77DD'
  ...
  const showCenter = (props.showCenter as boolean) ?? true
  const centerText = (props.centerText as string) ?? '—'
  const thickness = (props.thickness as number) ?? 28
  const animated = (props.animated as boolean) ?? true
...
// ─── Sparkline ────────────────────────────────────────────────────────────────
function generateSparkline(props: Record<string, unknown>): {
  tsx: string
  css: string
} {
  const color = (props.color as string) ?? '#7F77DD'
