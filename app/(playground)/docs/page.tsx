...
const DOCS: Record<DocId, React.ReactNode> = {
  overview: (
    <>
      ...
      <div className="d-cards">
        ...
        <div className="d-card">
          <div className="d-card-num">Own it</div>
          <div className="d-card-title">Your files, your code</div>
          <div className="d-card-desc">
            Two files land in your project. Readable React + CSS. Edit anything.
          </div>
        </div>
        <div className="d-card">
      ...
      <p className="d-p">
        Most component libraries ship as a black box. You import, it works, but
        you can&apos;t touch internals. When the API changes you&apos;re forced
        to upgrade. FORGE.ui uses the shadcn model — the files live in your
        project and belong to you — but adds a CLI that pre-configures
        everything before copying, and a config file that tracks what&apos;s
        installed so updates work cleanly later.
      </p>
      <div className="callout callout-tip">
        <div className="callout-icon">✦</div>
        <div>
          The playground is the UI for the CLI. Every visual choice maps to a
          flag. What you see in the preview is what lands in your project.
        </div>
      </div>
    </>
  ),
  ...
  quickstart: (
    <>
      ...
      <p className="d-p">
        ...
        <code>components/forge/forge-tokens.css</code>.
      </p>
      <h2 className="d-h2">2. Import the tokens</h2>
      <CB lang="tsx — app/layout.tsx">
        <span className="kw">import</span>{' '}
        <span className="str">
          &apos;@/components/forge/forge-tokens.css&apos;
        </span>
      </CB>
      <h2 className="d-h2">3. Add a component</h2>
      <p className="d-p">
        Configure in the playground and copy the generated command, or add with
        defaults:
      </p>
      <CB lang="bash">
        <span className="str">
      ...
      <CB lang="tsx">
        ...
        <span className="fn">ForgeButton</span>
        <span className="punc">{' }'}</span> <span className="kw">from</span>{' '}
        <span className="str">&apos;@/components/forge/ForgeButton&apos;</span>
        <br />
        <br />
        ...
        <br />
        {'      '}
        <span className="attr">variant</span>=
        <span className="str">&quot;glow&quot;</span>
        <br />
        {'    '}
  ...
  tokens: (
    <>
      ...
      <p className="d-lead">
        All tokens live in <code>forge-tokens.css</code>. Override any of them
        to retheme your entire installation.
      </p>
          ...
          {[
            ...
            <tr key={tok}>
              ...
              <td>
                ...
                >
                  {def.startsWith('#') && <Swatch bg={def} />}
                  <code style={{ color: 'var(--muted)' }}>{def}</code>
                </span>
              </td>
      ...
      <CB lang="css — your globals.css">
        <span className="fn">:root</span> {'{'}
        <br />
        {'  '}
        <span className="attr">--forge-purple</span>:{' '}
        <span className="num">#5B5BF0</span>;{'   '}
        <span className="cmt">{'/* your brand colour */'}</span>
        <br />
        {'  '}
        <span className="attr">--forge-bg</span>:{'     '}
        <span className="num">#06060a</span>;{'   '}
        <span className="cmt">{'/* slightly darker bg */'}</span>
        <br />
        {'  '}
        <span className="attr">--forge-font</span>:{'   '}
        <span className="str">&apos;Geist&apos;, sans-serif</span>;<br />
        {'}'}
      </CB>
    </>
  ),
  ...
  theming: (
    <>
      ...
      <p className="d-lead">
        Every component accepts a <code>color</code> prop. One hex value — the
        component derives every interactive state from it.
      </p>
      <h2 className="d-h2">How it works</h2>
      <p className="d-p">
        When the CLI generates a component, it calculates the RGB values from
        your <code>--color</code> flag and bakes them in as the default prop. At
        runtime, the component sets two CSS custom properties on itself:
      </p>
      <CB lang="generated at runtime">
        <span className="attr">--forge-color</span>:{' '}
        <span className="num">#7F77DD</span>;<br />
        <span className="attr">--forge-rgb</span>:{'   '}
        <span className="num">127, 119, 221</span>;
      </CB>
      <p className="d-p">The CSS uses these to derive every state:</p>
      <CB lang="ForgeButton.css">
        <span className="fn">.forge-btn--glow</span> {'{'}
        <br />
        {'  '}background:{'   '}
        <span className="fn">rgba</span>(<span className="attr">var</span>
        (--forge-rgb), <span className="num">0.10</span>);
        <br />
        {'  '}border-color: <span className="fn">rgba</span>(
        <span className="attr">var</span>(--forge-rgb),{' '}
        <span className="num">0.28</span>);
        <br />
        {'  '}color:{'        '}
        <span className="fn">rgba</span>(<span className="attr">var</span>
        (--forge-rgb), <span className="num">0.90</span>);
        <br />
        {'}'}
        <br />
        <span className="fn">.forge-btn--glow:hover</span> {'{'}
        <br />
        {'  '}border-color: <span className="fn">rgba</span>(
        <span className="attr">var</span>(--forge-rgb),{' '}
        <span className="num">0.55</span>);
        <br />
        {'  '}box-shadow: <span className="num">0 0 22px</span>{' '}
        <span className="fn">rgba</span>(<span className="attr">var</span>
        (--forge-rgb), <span className="num">0.25</span>);
        <br />
        {'}'}
      </CB>
      <div className="callout callout-tip">
        <div className="callout-icon">✦</div>
        <div>
          Use different colours for different components across your site. The
          system handles each independently — red for CTAs, blue for navigation,
          purple for SaaS features.
        </div>
      </div>
    </>
  ),
  ...
  'doc-button': (
    <>
      ...
      <p className="d-lead">
        Spectrum-aware button. 6 variants, ripple animation, lift/scale/glow
        hover, loading state, optional icon.
      </p>
      ...
      <table className="d-table">
        ...
        <tbody>
          {[
            ...
            [
              'variant',
              'glow|solid|ghost|outline|soft|spectrum',
              'glow',
              'Visual style',
            ],
  ...
  'doc-card': (
    <>
      ...
      <p className="d-lead">
        Card with a bottom-up colour glow on hover. Each card gets its own
        colour — assign different colours to distribute the spectrum across your
        UI.
      </p>
      <h2 className="d-h2">Install</h2>
      <CB lang="bash">
  ...
  'doc-input': (
    <>
      ...
      <p className="d-lead">
        Input with focus glow derived from the colour token and four validation
        states with automatic hint colouring.
      </p>
      <h2 className="d-h2">Install</h2>
      <CB lang="bash">
        <span className="str">
  ...
  'doc-badge': (
    <>
      ...
      <p className="d-lead">
        Status badge with optional animated pulse dot. Three shape variants.
      </p>
      <h2 className="d-h2">Install</h2>
      <CB lang="bash">
        <span className="str">
        ...
        <tbody>
          {[
            ...
            <tr key={comp}>
              ...
              <td style={{ fontSize: 12, color: 'var(--muted)' }}>{desc}</td>
              <td>
                <code style={{ color: 'var(--hint)' }}>{cmd}</code>
              </td>
            </tr>
          ))}
        </tbody>
  ...
  'doc-charts': (
    <>
      ...
      <p className="d-lead">
        5 chart components powered by Chart.js. Loaded from CDN to keep your
        bundle lean.
      </p>
      <h2 className="d-h2">Setup</h2>
      <p className="d-p">Add the Chart.js CDN script to your root layout:</p>
      <CB lang="tsx — app/layout.tsx">
        <span className="kw">import</span> Script{' '}
        <span className="kw">from</span>{' '}
        <span className="str">&apos;next/script&apos;</span>
        <br />
        <br />
        <span className="cmt">{'// Inside <body>:'}</span>
        <br />
        ...
        <span className="str">&quot;beforeInteractive&quot;</span>
        <br />
        <span className="tag">{'/>'}</span>
      </CB>
  ...
  'doc-overlay': (
    <>
      ...
      <p className="d-lead">
        5 overlay components for modals, toasts, tooltips, dropdowns and
        drawers.
      </p>
      <h2 className="d-h2">Components</h2>
      <table className="d-table">
      ...
      <div className="callout callout-info">
        ...
        <div>
          Overlay components in the playground are shown in a static preview
          mode. The full interactive component includes portal rendering and
  ...
  'cli-commands': (
    <>
      ...
      <p className="d-lead">
        The FORGE.ui CLI is a dev dependency — it writes files and exits.
  ...
  'cli-flags': (
    <>
      ...
      <p className="d-lead">
        Every flag maps to a component prop. Only flags that differ from
        defaults are needed — the rest are baked in.
      </p>
      ...
      <div className="callout callout-tip">
        <div className="callout-icon">✦</div>
        <div>
          The playground generates the exact flag set for the current component
          state. Use it as the canonical reference for available flags per
          component.
        </div>
      </div>
    </>
  ...
  'cli-config': (
    <>
      ...
      <CB lang="json — forge.config.json">
        ...
        {'  '}
        <span className="attr">&quot;components&quot;</span>: {'{'}
        <br />
        {'    '}
  ...
  return (
    <div className="docs-wrap">
      ...
      <div className="docs-body">
        <div style={{ maxWidth: 700 }}>{DOCS[active]}</div>
      </div>
    </div>
  )
}
